...
## 2024-05-24 - InstanceManager O(N) overhead
**Learning:** list_all() introduces unnecessary iteration overhead when only counting instances.
**Action:** Use an O(1) dictionary lookup instead.
