...
def validate_config() -> list[str]:
    ...
    if CLI_RUNNER not in ("claude", "gemini", "codex", "qwen", "opencode", "freecode", "generic", "free", "router", "openrouter", "antigravity"):
        errors.append(f"CLI_RUNNER='{CLI_RUNNER}' — must be claude, gemini, codex, qwen, freecode, generic, free, router, openrouter, or antigravity")
    if CLI_RUNNER not in ("generic", "free", "router", "openrouter", "antigravity") and not is_cli_available():
        errors.append(
