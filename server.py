...
PROMPTS = {
    ...
    "hm_info": (
        ...
        "Candidate background (for finding mutual context): Full-stack/AI engineer, Bloomberg LP alum, "
        "focused on AI agents, n8n automations, Claude/Gemini tools.\n\n"
    ...
    "linkedin_profile": (
        ...
        "      - mutual_context: any overlap with my background (Bloomberg LP alum, full-stack/AI engineer, "
        "n8n automations, Claude/Gemini tools) — empty string if none\n"
    ...
    "hm_info_orchestrator": (
        ...
        "     - mutual_context: any overlap with candidate background (Bloomberg LP alum, full-stack/AI "
        "engineer, n8n automations, Claude/Gemini tools) — empty string if none\n"
