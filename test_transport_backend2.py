...
def create_safe_client(**kwargs) -> httpx.AsyncClient:
    ...
    # The default backend is an instance of httpcore.backends.asyncio.AsyncioBackend
    # but we can just grab it from an existing transport
    default_backend = transport._pool._network_backend
    transport._pool._network_backend = SSRFNetworkBackend(default_backend)
